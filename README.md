...
<p align="center">
<a href="https://kitura-next.github.io/Swift-JWT/index.html">
<img src="https://img.shields.io/badge/apidoc-SwiftJWT-1FBCE4.svg?style=flat" alt="APIDoc">
</a>
<a href="https://travis-ci.org/Kitura-Next/Swift-JWT">
<img src="https://travis-ci.org/Kitura-Next/Swift-JWT.svg?branch=master" alt="Build Status - Master">
</a>
...
#### Add dependencies
Add the `Swift-JWT` package to the dependencies within your application’s `Package.swift` file. Substitute `"x.x.x"` with the latest `Swift-JWT` [release](https://github.com/Kitura-Next/Swift-JWT/releases).
```swift
.package(url: "https://github.com/Kitura-Next/Swift-JWT.git", from: "x.x.x")
```
...
For details on creating elliptic curve public and private keys, view the [BlueECC README.txt](https://github.com/Kitura-Next/BlueECC).
...
## API Documentation
For more information visit our [API reference](https://kitura-next.github.io/Swift-JWT/index.html).
...
## License
This library is licensed under Apache 2.0. Full license text is available in [LICENSE](https://github.com/Kitura-Next/Swift-JWT/blob/master/LICENSE).
